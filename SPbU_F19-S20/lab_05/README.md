...
Смотри стандартные требования из четвёртой лабораторной, название папки и файла — `lab_05`.
...
При желании вы можете реализовать свои тесты (см. требования в четвёртой лабораторной).
...
Задание выдано 14.10.2019 (пятница).
Промежуточный срок сдачи совпадает с крайним.
Крайний срок сдачи — **19.10.2019 (пятница) 22:59 по Москве**.
