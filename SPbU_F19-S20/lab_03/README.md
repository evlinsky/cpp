# Лабораторная №3 (`WW_intrusive_list`)
...
Гарантируется, что команда либо корректна, либо её первый токен
(название операции) не совпадает ни с одном из перечисленных выше.
Например, команда `sort 1 2` может быть подана на вход,
а вот `add 10` — уже нет.
...
Задание выдано 30.09.2019 (понедельник).
Крайний срок сдачи — 09.10.2019 (среда) 22:59 по Москве.
